class CustomView {
    ...
    static async getCustomViews(moduleAPIName){
        ...
        let customViewsOperations = new ZCRM.CustomView.Operations(moduleAPIName);

        //Get instance of ParameterMap Class
        let paramInstance = new ParameterMap();

        //Possible parameters of Get CustomViews operation
        paramInstance.add(ZCRM.CustomView.Model.GetCustomViewsParam.PAGE, 1);

        paramInstance.add(ZCRM.CustomView.Model.GetCustomViewsParam.PER_PAGE, 20);

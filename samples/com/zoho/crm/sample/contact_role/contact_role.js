class ContactRole{
    ...
    static async createContactRoles(){
        ...
        let request = new ZCRM.ContactRole.Model.BodyWrapper();
        ...
        for (let index = 1; index < 5; index++) {
            ...
            contactRole.setName("contactRole" + index.toString());
    ...
    static async updateContactRoles(){
        ...
        //Get instance of ContactRole Class
        let cr1 = new ZCRM.ContactRole.Model.ContactRole();

        //Set ID to the ContactRole instance
        cr1.setId(34770617941001n);
        ...
        //Get instance of ContactRole Class
        cr1 = new ZCRM.ContactRole.Model.ContactRole();

        //Set ID to the ContactRole instance
        cr1.setId(34770617683043n);

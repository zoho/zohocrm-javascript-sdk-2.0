class Module{
    ...
    static async updateModuleByAPIName(moduleAPIName){
        ...
        let module = new ZCRM.Module.Model.Module();
        ...
        let request = new ZCRM.Module.Model.BodyWrapper();
        ...
        if(response != null){
            ...
            if(responseObject != null){
                ...
                if(responseObject instanceof ZCRM.Module.Model.ActionWrapper){
                    ...
                    actionResponses.forEach(actionResponse => {
                        ...
                        if(actionResponse instanceof ZCRM.Module.Model.SuccessResponse){
                        ...
                        //Check if the request returned an exception
                        else if(actionResponse instanceof ZCRM.Module.Model.APIException){

class RelatedRecord {
    ...
    static async getRelatedRecords(moduleAPIName, recordId, relatedListAPIName) {
        ...
        let relatedRecordsOperations = new ZCRM.RelatedRecord.Operations(relatedListAPIName, moduleAPIName);
   ...
   */
    static async updateRelatedRecords(moduleAPIName, recordId, relatedListAPIName) {
         ...
         * 2 -> Value
         */
        record1.addKeyValue("id", 347706105917011n);
         ...
         * 2 -> Value
         */
        record2.addKeyValue("id", 340964302414001n);
        ...
        //Call updateRelatedRecords method that takes recordId, BodyWrapper instance
    ...
    static async deLinkRecords(moduleAPIName, recordId, relatedListAPIName, relatedListIds) {
        ...
        // let recordId = 34096430798007n;
        // let relatedModuleAPIName = "Price_Books";
        // let relatedIds = [3409614001n, 340962414002n, 34014020n];
    ...
    */
    static async getRelatedRecordsUsingExternalId(moduleAPIName, externalValue, relatedListAPIName) {
        //example
        //let moduleAPIName = "Products";
        // let externalValue = "340964300798007";
        // let relatedListAPIName = "Price_Books";
        ...
        let relatedRecordsOperations = new ZCRM.RelatedRecord.Operations(relatedListAPIName, moduleAPIName, xExternal);
        ...
        /* Possible headers for Get Related Records operation */
        await headerInstance.add(ZCRM.RelatedRecord.Model.GetRelatedRecordUsingExternalIDHeader.IF_MODIFIED_SINCE, new Date('October 15, 2019 05:35:32'));
    ...
    static async updateRelatedRecordsUsingExternalId(moduleAPIName, externalValue, relatedListAPIName) {
        ...
        //Call updateRelatedRecordsUsingExternalId method that takes externalValue, BodyWrapper instance
    ...
    static async deleteRelatedRecordsUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, relatedListIds) {
        ...
        // let recordId = 34096430798007n;
        // let relatedModuleAPIName = "Price_Books";
        // let relatedIds = [34096434001n, 34096432n, 3409643020n];
        let xExternal = "Products.Products_External";
        ...
        //Call deleteRelatedRecordsUsingExternalId method that takes externalValue, ParameterMap instance as parameter.
     ...
     */
    static async getRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue) {
        //example
        // let moduleAPIName = "Products";
        // let externalValue = "3409698007";
        // let relatedModuleAPIName = "Price_Books";
        // let externalFieldValue = "3409644001";
    ...
    static async updateRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue) {
        ...
        // let relatedModuleAPIName = "Price_Books";
        // let externalFieldValue = "34096001n";
        let xExternal = "Leads.External,Products.Products_External";
    ...
    static async deleteRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue) {
        ...
        // let externalValue = "34096430798007";
        // let relatedModuleAPIName = "Price_Books";
        // let externalFieldValue = "34096414001";
